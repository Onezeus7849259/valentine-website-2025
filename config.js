...
const CONFIG = {
    ...
    colors: {
        backgroundStart: "#633D95",      // Gradient start (try pastel colors for a soft look)
        backgroundEnd: "#C763B1",        // Gradient end (should complement backgroundStart)
        buttonBackground: "#A04086",     // Button color (should stand out against the background)
        buttonHover: "#DB89CA",          // Button hover color (slightly lighter than buttonBackground)
        textColor: "#131986"             // Text color (make sure it's readable!)
    },
